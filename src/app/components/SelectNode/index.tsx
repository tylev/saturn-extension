  ...
  render() {
    ...
    if (nodeType) {
      if (isRequestingPermission || isScanningLocal) {
        ...
        // we have nodeType, but not isRequestingPermission, not isScanningLocal, not isNodeChecked, not nodeType === NODE_TYPE.BTCPAY_SERVER
        title = 'Provide a URL';
        // this.setUrl(DEFAULT_NODE_URLS.LOCAL);
        content = (
          <InputAddress
